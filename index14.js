...
const predefinedResponses = {
    ...
    "which country": "I don't belong to any specific country. I'm here to help you with your queries.",
    ...
    "tell me the name of your problem statement":"Automated Water Tank mangement System",	
...
const handleChat = () => {
    ...
    setTimeout(() => {
        ...
        if (predefinedResponse) {
            ...
            incomingChatLi.querySelector("p").textContent = predefinedResponses.default;
        }
    }, 600);
}
